...
Test Suite
     [Arguments]    ${index}
     ${kuantitas}      Read Excel    ${CURDIR}${/}..\\Data\\Data.xlsx    Sheet3    ${index}    1
     ${tanggal}      Read Excel    ${CURDIR}${/}..\\Data\\Data.xlsx    Sheet3    ${index}    2
   ...
   Sleep    2
   Input Text        xpath=/html/body/div[1]/div[1]/div[2]/div[2]/div/div/div/div/div[2]/div/div[2]/form/div[2]/input       ${kuantitas}
   Sleep    5
   Input Text        //*[@id="expired_date"]        ${tanggal} 
   Sleep    5
